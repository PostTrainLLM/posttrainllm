GOAL:
Run blind OffHours pilot-v3 saturation pass 3 at commit
...
- Scratch: /tmp/offhours-devin-v3-inputs-pass3.json and
  /tmp/offhours-devin-v3-answers-pass3.json.
- Do not edit the worktree.

BLIND PROTOCOL:
1. Run exactly:
   jq '[.claims[] | {task_id, input}]' configs/offhours/claims-pilot-v3.json > /tmp/offhours-devin-v3-inputs-pass3.json
