GOAL:
Run blind OffHours pilot-v3 saturation pass 1 at commit
...
- Scratch: /tmp/offhours-devin-v3-inputs-pass1c.json and
  /tmp/offhours-devin-v3-answers-pass1c.json.
- Do not edit the worktree.

BLIND PROTOCOL:
1. Run exactly:
   jq '[.claims[] | {task_id, input}]' configs/offhours/claims-pilot-v3.json > /tmp/offhours-devin-v3-inputs-pass1c.json
