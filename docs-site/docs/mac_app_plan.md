---
title: "Native macOS app — build plan"
description: "The browser playground is the on-ramp. The Mac app is the depth: same"
---
...
Don't skip ahead; the value of posttrainllm-the-product was always
