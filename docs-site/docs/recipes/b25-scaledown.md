---
title: "Recipe — B25 ScaleDown specialist (extractive context compression)"
description: "**Goal:** train a small posttrainllm model that takes `(question, long_document)`"
---
