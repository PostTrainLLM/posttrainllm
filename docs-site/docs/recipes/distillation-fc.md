---
title: "Recipe — distill function-calling from Phi-3-mini → posttrainllm-Huge"
description: "**Goal:** produce a 22M-param specialist that matches Phi-3-mini-4k-instruct"
---
