---
title: "StreamingLLM + KIVI — long-context decode without growing the KV cache"
description: "Two changes that let `posttrainllm sample` survive arbitrarily long generations"
---
