---
title: "Tool-calling: how close can a Mac-local small model get to frontier?"
description: "**What:** the arc from 'our 1.7B scores ~55% on tool-calling' to a frontier-validated"
---
