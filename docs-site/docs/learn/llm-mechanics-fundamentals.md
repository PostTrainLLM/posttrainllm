...
description: "**Audience:** anyone who understands 'tokens are character chunks, model predicts next token' but wants to see *where matrix multiplication comes in* and *why e"
---
