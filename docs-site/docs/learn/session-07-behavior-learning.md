---
title: "Session 7 — How models learn behavior (supervised, imitation, reinforcement)"
description: "A language model's job is: given the text so far, predict the next token."
---
