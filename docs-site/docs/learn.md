---
title: "Learn posttrainllm — a guided path for software engineers new to AI"
description: "You can write code. You have never built or trained a neural network. This guide"
---
