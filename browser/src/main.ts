...
function refreshSampleNote(): void {
  ...
  noteEl.innerHTML =
    ...
    `<a href="https://github.com/PostTrainLLM/tinygpt/blob/main/python_ref/train.py" target="_blank" rel="noopener">the Python reference</a>.` +
    `</span>`;
}
...
function encodeModelFile(config: RunConfig, state: ArrayBuffer): Blob {
  ...
  const headerObj = {
    ...
    project: "https://github.com/PostTrainLLM/tinygpt",
  };
