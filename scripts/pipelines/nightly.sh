#!/usr/bin/env bash
# scripts/pipelines/nightly.sh — pick the next nightly training job and run it.
#
# Usage:
#   ./scripts/pipelines/nightly.sh             # run next pending job
#   ./scripts/pipelines/nightly.sh --list      # show queue + done status, exit
#   ./scripts/pipelines/nightly.sh --dry       # show what would run, exit
#
