...
python3 /Users/sarthak/Desktop/fleet/posttrainllm/scripts/pace/eval_pace_v2.py \
...
python3 /Users/sarthak/Desktop/fleet/posttrainllm/scripts/bfcl/eval_bfcl.py \
  --max-per-category 15 \
  --serve-url http://127.0.0.1:8765/v1/chat/completions \
