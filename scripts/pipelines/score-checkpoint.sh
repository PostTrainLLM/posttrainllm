#!/usr/bin/env bash
# scripts/pipelines/score-checkpoint.sh — fire-and-forget post-training scoring.
#
# Usage:
#   ./scripts/pipelines/score-checkpoint.sh <ckpt.tinygpt> [out.jsonl]
#   ./scripts/pipelines/score-checkpoint.sh ~/.cache/posttrainllm/runs/huge-base-v1/huge-base-v1.tinygpt
#
