#!/usr/bin/env bash
# scripts/bench/duty-cycle-throttle.sh — throttle a long-running process via SIGSTOP/SIGCONT duty cycling.
#
# Usage:
#   ./scripts/bench/duty-cycle-throttle.sh <PID> [duty=0.5] [period_secs=60]
#
