...
Usage:
  ...
  python3 scripts/bench/bench_task_latency.py \
...
# pace/ is a sibling group under scripts/; add it to the import path.
sys.path.insert(0, str(Path(__file__).resolve().parent.parent.joinpath("pace")))
