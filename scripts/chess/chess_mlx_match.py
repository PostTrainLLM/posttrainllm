...
def main() -> int:
    ...
    if openings.get("schema_version") != "chess/openings/v1" or not openings.get(
        "openings"
    ):
    ...
    result = {
        ...
        "models": [
            {
                "policy_id": args.policy_a,
                "model_ref": args.model_a_ref,
                "model_load_time_ms": policy_a.model_load_time_ms,
            },
            {
                "policy_id": args.policy_b,
                "model_ref": args.model_b_ref,
                "model_load_time_ms": policy_b.model_load_time_ms,
            },
        ],
        "aggregate": {
            "games": len(games),
            "wins": wins,
            "draws": draws,
            "invalid_forfeits": invalid_forfeits,
        },
        "games": games,
    }
