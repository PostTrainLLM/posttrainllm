...
Usage:
    ...
    python3 scripts/check_foundry_receipt.py receipt.json
    python3 scripts/foundry_receipt.py --check        # self-check
    cat receipt.json | python3 scripts/check_foundry_receipt.py -
"""
