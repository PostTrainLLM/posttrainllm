...
Commands:
    ...
    python3 scripts/research/capability_gradient_lab.py validate-scorecard
    python3 scripts/research/capability_gradient_lab.py validate-probes
    python3 scripts/research/capability_gradient_lab.py canonical-trace --env connect4 --seed 42
    python3 scripts/research/capability_gradient_lab.py canonical-trace --env calendar --seed 42
    python3 scripts/research/capability_gradient_lab.py random-baseline --env connect4 --seeds 0-9
    python3 scripts/research/capability_gradient_lab.py random-baseline --env calendar --seeds 0-9
    python3 scripts/research/capability_gradient_lab.py play --env connect4 --seed 42 --actions <complete-comma-separated-policy-trace>
    python3 scripts/research/capability_gradient_lab.py play --env calendar --seed 42 --action "mon 14:00"
"""
