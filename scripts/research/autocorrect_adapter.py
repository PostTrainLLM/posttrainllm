...
Usage:
    python3 scripts/research/autocorrect_adapter.py validate
    python3 scripts/research/autocorrect_adapter.py plan --stage tiny_overfit
    python3 scripts/research/autocorrect_adapter.py selftest
"""
...
def _foundation() -> Any:
    ...
    path = ROOT / "scripts" / "research" / "autocorrect_foundation.py"
...
def _query_module() -> Any:
    query_path = ROOT / "scripts" / "docs-checks" / "query_attempts.py"
...
def print_prior_attempts(recipe: dict[str, Any], limit: int = 5) -> None:
    ...
    if len(related) > limit:
        print(
            f"  ... {len(related) - limit} more: python3 scripts/docs-checks/query_attempts.py --help"
        )
