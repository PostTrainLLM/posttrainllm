...
def main() -> int:
    ...
    artifact = {
        ...
        "reproduce": {
            ...
            "command_template": "python3.12 scripts/game_2048_mlx_pilot.py --model <MODEL_REF> --policy-id <ID> --track strict --seed 2048000000 --seed 2048000001 --seed 2048000002 --max-moves 128 --output runs/game-2048/model-pilot/<ID>.json",
