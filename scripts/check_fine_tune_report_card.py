...
"""Validate a Fine-Tune Report Card before it enters the public artifact registry.
    ...
    python3 scripts/check_fine_tune_report_card.py <report-card.json> [...]
    python3 scripts/check_fine_tune_report_card.py --allow-report-only <path>
...
`scripts/check_factory_run_publish.py` for the derived report-card layer.
"""
