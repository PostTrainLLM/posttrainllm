...
receipt is validated by ``scripts/factory/check_foundry_receipt.py``.
...
Usage:
    ...
    python3 scripts/factory/foundry_receipt.py                    # write to stdout
    python3 scripts/factory/foundry_receipt.py --out receipt.json
    python3 scripts/factory/foundry_receipt.py --runs runs/       # include local runs
    python3 scripts/factory/foundry_receipt.py --no-ci            # skip gh query
    python3 scripts/factory/foundry_receipt.py --check            # validate after emit
"""
