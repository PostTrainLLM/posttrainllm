...
def main() -> int:
    ...
    artifact = {
        ...
        "reproduce": {
            ...
            "puzzle_command": "python3.12 scripts/chess_mlx_pilot.py --suite evals/chess/fixtures/development-puzzles-v1.json --model <MODEL_PATH> --model-ref <MODEL_REF> --policy-id <ID> --output runs/chess/<ID>.json",
            "match_command": "python3.12 scripts/chess_mlx_match.py --openings configs/chess/openings-development-v1.json --model-a <PATH_A> --model-a-ref <REF_A> --policy-a <ID_A> --model-b <PATH_B> --model-b-ref <REF_B> --policy-b <ID_B> --output runs/chess/match.json",
